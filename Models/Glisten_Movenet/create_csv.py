...
if os.path.exists(csvs_out_train_path):
        print(f"训练数据的 CSV 文件成功生成：{csvs_out_train_path}")
else:
        print(f"训练数据的 CSV 文件未生成：{csvs_out_train_path}")

if os.path.exists(csvs_out_test_path):
        print(f"测试数据的 CSV 文件成功生成：{csvs_out_test_path}")
else:
        print(f"测试数据的 CSV 文件未生成：{csvs_out_test_path}")
